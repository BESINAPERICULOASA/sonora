...
- YouTube Music playback uses the signed-in account's best available audio, including Premium
  AAC and Opus streams, with ordinary playback as a fallback. WebM audio is supported. A Premium
  badge appears in Settings → General once the session confirms access to High-tier audio.
